...
def get_predicted_value(patient_symptoms):
    ...
    predicted_index = int(svc.predict([input_vector])[0])
...
def predict():
    if request.method=='POST':
        ...
        return render_template('index.html',predicted_disease=predicted_disease,dis_desc=desc,dis_pre=my_pre,dis_med=med,dis_wrkout=wrkout,dis_die=die)
