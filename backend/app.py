...
# Load the dataset
training_df = pd.read_csv(r'C:\Users\HP\Desktop\MedicalRecommendationSystem\datasets\Training.csv')

# Remove the last column (target 'prognosis') and separate features (X) and target (y)
X = training_df.drop('prognosis', axis=1)
y = training_df['prognosis']

# Encode string labels in 'y' to integer values
le = LabelEncoder()
le.fit(y)
y_encoded = le.transform(y)

# Convert string columns in X to numerical values
...
# Train the SVC model separately
svc = SVC(kernel="linear", random_state=42)
svc.fit(X_train, y_train)

# Make predictions with the trained SVC model
...
model_path = r'C:\Users\HP\Desktop\MedicalRecommendationSystem\models\svc.pkl'
with open(model_path, 'wb') as model_file:
    pickle.dump(svc, model_file)
print(f"Model saved to {model_path}")

# Load the saved model
loaded_svc = pickle.load(open(model_path, 'rb'))

# Test the model with a single prediction
print("Predicted label:", loaded_svc.predict(X_test.iloc[10].values.reshape(1, -1))[0])
...
# Load datasets
symptoms_df = pd.read_csv(r"C:\Users\HP\Desktop\MedicalRecommendationSystem\datasets\symtoms_df.csv")
precautions = pd.read_csv(r"C:\Users\HP\Desktop\MedicalRecommendationSystem\datasets\precautions_df.csv")
workout = pd.read_csv(r"C:\Users\HP\Desktop\MedicalRecommendationSystem\datasets\workout_df.csv")
description = pd.read_csv(r"C:\Users\HP\Desktop\MedicalRecommendationSystem\datasets\description.csv")
medications = pd.read_csv(r"C:\Users\HP\Desktop\MedicalRecommendationSystem\datasets\medications.csv")
diets = pd.read_csv(r"C:\Users\HP\Desktop\MedicalRecommendationSystem\datasets\diets.csv")

# Load the saved model
svc = pickle.load(open(r"C:\Users\HP\Desktop\MedicalRecommendationSystem\models\svc.pkl", 'rb'))
...
# Create dictionaries for symptom and disease mappings
